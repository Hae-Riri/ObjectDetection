...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    Button settingBtn = (Button)findViewById(R.id.SettingMenu);
    settingBtn.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        Intent intent1 = new Intent(CameraActivity.this, SettingMenu.class);
  ...
  public void onSensorChanged(SensorEvent event) {
    if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
      ...
      if (gForce > SHAKE_THRESHOLD_GRAVITY) {
        ...
        //실행
        //doSomething
        Boolean emergencyIntent = PrefrenceManager.getBoolean(this, "emergencyIntent");
        if (!emergencyIntent) {//아직 인텐트안한거면
          Intent intent = new Intent(CameraActivity.this, EmergencyActivity.class);
          startActivity(intent);
          PrefrenceManager.setBoolean(this, "emergencyIntent", true);
          finish();
        }
      }
    }
